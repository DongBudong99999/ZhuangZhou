define("echarts/chart/map", ["require", "./base", "zrender/shape/Text", "zrender/shape/Path", "zrender/shape/Circle", "zrender/shape/Rectangle", "zrender/shape/Line", "zrender/shape/Polygon", "zrender/shape/Ellipse", "../component/dataRange", "../component/roamController", "../config", "../util/ecData", "zrender/tool/util", "zrender/config", "zrender/tool/event", "../util/mapData/params", "../util/mapData/textFixed", "../util/mapData/geoCoord", "../util/projection/svg", "../util/projection/normal", "../chart"], function (e) {
    ...
    var n = e("./base"), i = e("zrender/shape/Text"), a = e("zrender/shape/Path"), o = e("zrender/shape/Circle"),
    ...
    var V = e("../util/ecData"), U = e("zrender/tool/util"), d = e("zrender/config"), p = e("zrender/tool/event"),
        c = e("../util/mapData/params").params, u = e("../util/mapData/textFixed"), y = e("../util/mapData/geoCoord");
    return t.prototype = {
        type: m.CHART_TYPE_MAP, _buildShape: function () {
            ...
            for (var t, n, i, a, o = this.component.legend, r = {}, s = {}, l = {}, h = {}, V = 0, d = e.length; d > V; V++) if (e[V].type == m.CHART_TYPE_MAP && (e[V] = this.reformOption(e[V]), n = e[V].mapType, s[n] = s[n] || {}, s[n][V] = !0, l[n] = l[n] || e[V].mapValuePrecision, this._scaleLimitMap[n] = this._scaleLimitMap[n] || {}, e[V].scaleLimit && U.merge(this._scaleLimitMap[n], e[V].scaleLimit, !0), this._roamMap[n] = e[V].roam || this._roamMap[n], this._hoverLinkMap[n] = e[V].dataRangeHoverLink || this._hoverLinkMap[n], this._nameMap[n] = this._nameMap[n] || {}, e[V].nameMap && U.merge(this._nameMap[n], e[V].nameMap, !0), this._activeMapType[n] = !0, e[V].textFixed && U.merge(u, e[V].textFixed, !0), e[V].geoCoord && U.merge(y, e[V].geoCoord, !0), this._selectedMode[n] = this._selectedMode[n] || e[V].selectedMode, (null == this._hoverable[n] || this._hoverable[n]) && (this._hoverable[n] = e[V].hoverable), (null == this._clickable[n] || this._clickable[n]) && (this._clickable[n] = e[V].clickable), (null == this._showLegendSymbol[n] || this._showLegendSymbol[n]) && (this._showLegendSymbol[n] = e[V].showLegendSymbol), h[n] = h[n] || e[V].mapValueCalculation, t = e[V].name, this.selectedMap[t] = o ? o.isSelected(t) : !0, this.selectedMap[t])) {
                ...
                for (var p = 0, g = i.length; g > p; p++) {
                    a = this._nameChange(n, i[p].name), r[n][a] = r[n][a] || {seriesIndex: []};
            ...
            var i, a = this._mapDataMap[e].projection, o = [],
            ...
            if ("china" == e) {
                var p = this.geo2pos(e, y["鍗楁捣璇稿矝"] || c["鍗楁捣璇稿矝"].textCoord), g = i.scale.x / 10.5,
                    b = [32 * g + p[0], 83 * g + p[1]];
                u["鍗楁捣璇稿矝"] && (b[0] += u["鍗楁捣璇稿矝"][0], b[1] += u["鍗楁捣璇稿矝"][1]), o.push({
                    name: this._nameChange(e, "鍗楁捣璇稿矝"),
                    path: c["鍗楁捣璇稿矝"].getPath(p, g),
                    position: h,
                    textX: b[0],
                    textY: b[1]
                })
            ...
            var r = e("../util/projection/normal"), s = r.getBbox(n), l = this.geo2pos(t, [a.left, a.top]),
            ...
            var u = {OffsetLeft: l[0], OffsetTop: l[1], scale: {x: p, y: c}}, y = r.geoJson2Path(n, u);
            return this._getSingleProvince(t, y[0], o)
        }, _getSingleProvince: function (e, t, n) {
            var i, a = t.properties.name, o = u[a] || [0, 0];
            if (y[a]) i = this.geo2pos(e, y[a]); else if (t.cp) i = [t.cp[0] + o[0], t.cp[1] + o[1]]; else {
            ...
            var i, a, o, r, s, l, h, m = this.series, V = this.zr.getWidth(), U = this.zr.getHeight(),
            ...
            if (!(0 >= this.shapeList.length)) {
                ...
                for (s in d) if (d[s]) {
                    c = !0;
                    var u = this._mapDataMap[s].transform, y = u.left, g = u.top, b = u.width, f = u.height,
            ...
            if (!(0 >= this.shapeList.length)) {
                var t = e.target;
                if (!t || !t.draggable) {
                    var n = e.event, i = p.getX(n), a = p.getY(n), o = this._findMapTypeByPos(i, a);
            ...
            if (this._mousedown && this._isAlive) {
                var t = e.event, n = p.getX(t), i = p.getY(t), a = this._mapDataMap[this._curMapType].transform;
            ...
            switch (e.roamType) {
                case"scaleUp":
                    return t.zrenderDelta = 1, this.__onmousewheel({event: t, mapTypeControl: n}), void 0;
                case"scaleDown":
                    return t.zrenderDelta = -1, this.__onmousewheel({event: t, mapTypeControl: n}), void 0;
                case"up":
                    i = -o;
            ...
            for (var t, n, i = 0, a = this.shapeList.length; a > i; i++) t = this.shapeList[i]._mapType, this._hoverLinkMap[t] && this._activeMapType[t] && (n = V.get(this.shapeList[i], "value"), null != n && n >= e.valueMin && e.valueMax >= n && this.zr.addHoverShape(this.shapeList[i]))
        }, onclick: function (e) {
    ...
    return s.prototype = {
        type: "path", buildPathArray: function (e, t, n) {
            ...
            for (r = 1; s.length > r; r++) {
                ...
                V = V.slice(1), V = V.replace(RegExp("e,-", "g"), "e-");
                var d = V.split(",");
                ...
                for (; d.length > 0 && !isNaN(d[0]);) {
                    ...
                    for (var K = 0, v = L.length; v > K; K += 2) L[K] += t, L[K + 1] += n;
                    l.push(new i(_ || U, L))
                }
            ...
            var V = m * (Math.PI / 180), U = Math.cos(V) * (e - n) / 2 + Math.sin(V) * (t - i) / 2,
                d = -1 * Math.sin(V) * (e - n) / 2 + Math.cos(V) * (t - i) / 2, p = U * U / (l * l) + d * d / (h * h);
            p > 1 && (l *= Math.sqrt(p), h *= Math.sqrt(p));
            var c = Math.sqrt((l * l * h * h - l * l * d * d - h * h * U * U) / (l * l * d * d + h * h * U * U));
            a === s && (c *= -1), isNaN(c) && (c = 0);
            var u = c * l * d / h, y = c * -h * U / l, g = (e + n) / 2 + Math.cos(V) * u - Math.sin(V) * y,
                b = (t + i) / 2 + Math.sin(V) * u + Math.cos(V) * y, f = r([1, 0], [(U - u) / l, (d - y) / h]),
                k = [(U - u) / l, (d - y) / h], x = [(-1 * U - u) / l, (-1 * d - y) / h], _ = r(k, x);
            return -1 >= o(k, x) && (_ = Math.PI), o(k, x) >= 1 && (_ = 0), 0 === s && _ > 0 && (_ -= 2 * Math.PI), 1 === s && 0 > _ && (_ += 2 * Math.PI), [g, b, l, h, f, _, V, s]
                ...
                switch (d) {
                    ...
                    case"A":
                        var p = m[0], c = m[1], u = m[2], y = m[3], g = m[4], b = m[5], f = m[6], k = m[7],
                            x = u > y ? u : y, _ = u > y ? 1 : u / y, L = u > y ? y / u : 1;
            ...
            for (var n = Number.MAX_VALUE, i = Number.MIN_VALUE, a = Number.MAX_VALUE, o = Number.MIN_VALUE, r = e.x || 0, s = e.y || 0, l = e.pathArray || this.buildPathArray(e.path), h = 0; l.length > h; h++) for (var m = l[h].points, V = 0; m.length > V; V++) 0 === V % 2 ? (n > m[V] + r && (n = m[V]), m[V] + r > i && (i = m[V])) : (a > m[V] + s && (a = m[V]), m[V] + s > o && (o = m[V]));
            var U;
    ...
    return n.prototype = {
        type: "ellipse", buildPath: function (e, t) {
            var n = .5522848, i = t.x, a = t.y, o = t.a, r = t.b, s = o * n, l = r * n;
    ...
    function t(e, t, i, a, o) {
        if (this.query(a, "dataRange.min") === void 0 || this.query(a, "dataRange.max") === void 0) return console.error("option.dataRange.min or option.dataRange.max has not been defined."), void 0;
        n.call(this, e, t, i, a, o);
        var s = this;
    ...
    var n = e("./base"), i = e("zrender/shape/Text"), a = e("zrender/shape/Rectangle"),
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_DATARANGE, _textGap: 10, _buildShape: function () {
            if (this._itemGroupLocation = this._getItemGroupLocation(), this._buildBackground(), 0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable ? this._buildGradient() : this._buildItem(), this.dataRangeOption.show) for (var e = 0, t = this.shapeList.length; t > e; e++) this.zr.addShape(this.shapeList[e]);
            this._syncShapeFromRange()
        }, _buildItem: function () {
            var e, t, n, o, r = this._valueTextList, s = r.length, l = this.getFont(this.dataRangeOption.textStyle),
                m = this._itemGroupLocation.x, V = this._itemGroupLocation.y, U = this.dataRangeOption.itemWidth,
                d = this.dataRangeOption.itemHeight, p = this.dataRangeOption.itemGap, c = h.getTextHeight("鍥�", l);
            ...
            var t, n, o = this.getFont(this.dataRangeOption.textStyle), r = this._itemGroupLocation.x,
                s = this._itemGroupLocation.y, l = this.dataRangeOption.itemWidth, m = this.dataRangeOption.itemHeight,
                V = h.getTextHeight("鍥�", o), U = 10, d = !0;
            ...
            var e, t, n = this._calculableLocation.x, i = this._calculableLocation.y,
                a = this._calculableLocation.width, r = this._calculableLocation.height, s = 5;
            "horizontal" == this.dataRangeOption.orient ? "bottom" != this.dataRangeOption.y ? (e = [[n, i + r], [n - s, i + r + s], [n + s, i + r + s]], t = "bottom") : (e = [[n, i], [n - s, i - s], [n + s, i - s]], t = "top") : "right" != this.dataRangeOption.x ? (e = [[n + a, i], [n + a + s, i - s], [n + a + s, i + s]], t = "right") : (e = [[n, i], [n - s, i - s], [n - s, i + s]], t = "left"), this._indicatorShape = {
                style: {
                    pointList: e,
                    color: "#fff",
                    __rect: {
            ...
            var e, t, n, i, a, r, s, l, m = this._calculableLocation.x, V = this._calculableLocation.y,
                U = this._calculableLocation.width, d = this._calculableLocation.height,
                p = this.getFont(this.dataRangeOption.textStyle), c = h.getTextHeight("鍥�", p),
            ...
            var e = this._valueTextList, t = e.length, n = this.dataRangeOption.itemGap,
                i = this.dataRangeOption.itemWidth, a = this.dataRangeOption.itemHeight, o = 0, r = 0,
                s = this.getFont(this.dataRangeOption.textStyle), l = h.getTextHeight("鍥�", s), m = 10;
            if ("horizontal" == this.dataRangeOption.orient) {
                if (this.dataRangeOption.text || 0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable) o = (0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable ? i * m + n : t * (i + n)) + (this.dataRangeOption.text && this.dataRangeOption.text[0] !== void 0 ? h.getTextWidth(this.dataRangeOption.text[0], s) + this._textGap : 0) + (this.dataRangeOption.text && this.dataRangeOption.text[1] !== void 0 ? h.getTextWidth(this.dataRangeOption.text[1], s) + this._textGap : 0); else {
                    i += 5;
                ...
                var U;
                if (this.dataRangeOption.text || 0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable) r = (0 >= this.dataRangeOption.splitNumber || this.dataRangeOption.calculable ? a * m + n : t * (a + n)) + (this.dataRangeOption.text && this.dataRangeOption.text[0] !== void 0 ? this._textGap + l : 0) + (this.dataRangeOption.text && this.dataRangeOption.text[1] !== void 0 ? this._textGap + l : 0), U = Math.max(h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[0] || "", s), h.getTextWidth(this.dataRangeOption.text && this.dataRangeOption.text[1] || "", s)), o = Math.max(i, U); else {
                    r = (a + n) * t, i += 5, U = 0;
            ...
            var i = this._calculableLocation.x, a = this._calculableLocation.y, o = this._calculableLocation.width,
                r = this._calculableLocation.height;
            return "horizontal" == this.dataRangeOption.orient ? i >= e.style.x + t ? e.style.x = i : e.style.x + t + e.style.width >= i + o ? e.style.x = i + o - e.style.width : e.style.x += t : a >= e.style.y + n ? e.style.y = a : e.style.y + n + e.style.height >= a + r ? e.style.y = a + r - e.style.height : e.style.y += n, "filler" == e._type ? this._syncHandleShape() : this._syncFillerShape(e), this.dataRangeOption.realtime && this._dispatchDataRange(), !0
            ...
            this.messageCenter.dispatch(r.EVENT.DATA_RANGE_HOVERLINK, e.event, {valueMin: t, valueMax: n}, this.myChart)
            ...
            if (this.dataRangeOption.show && this.dataRangeOption.hoverLink && this._indicatorShape && e && null != e.seriesIndex && null != e.dataIndex) {
                var t = e.value;
                if ("" === t || isNaN(t)) return;
                this.dataRangeOption.min > t ? t = this.dataRangeOption.min : t > this.dataRangeOption.max && (t = this.dataRangeOption.max), this._indicatorShape.position = "horizontal" == this.dataRangeOption.orient ? [(this.dataRangeOption.max - t) / (this.dataRangeOption.max - this.dataRangeOption.min) * this._calculableLocation.width, 0] : [0, (this.dataRangeOption.max - t) / (this.dataRangeOption.max - this.dataRangeOption.min) * this._calculableLocation.height], this._indicatorShape.style.text = this._textFormat(e.value), this._indicatorShape.style.color = this.getColor(t), this.zr.addHoverShape(this._indicatorShape)
            }
    ...
    function t(e, t, i, a, o) {
        if (a.roamController && a.roamController.show) {
            if (!a.roamController.mapTypeControl) return console.error("option.roamController.mapTypeControl has not been defined."), void 0;
    ...
    var n = e("./base"), i = e("zrender/shape/Rectangle"), a = e("zrender/shape/Sector"), o = e("zrender/shape/Circle"),
        r = e("../config");
    r.roamController = {
        zlevel: 0,
        z: 4,
    ...
    return t.prototype = {
        type: r.COMPONENT_TYPE_ROAMCONTROLLER, _buildShape: function () {
            ...
            var t = this._itemGroupLocation.r, n = this._itemGroupLocation.x + t, i = this._itemGroupLocation.y + t,
                o = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    style: {
            ...
            n = 0 > n ? 20 : n;
            var i = Math.min(t / 2 - 5, n) / 2, a = this._itemGroupLocation.x + ("scaleDown" === e ? t - i : i),
                r = this._itemGroupLocation.y + this._itemGroupLocation.height - i, s = {
                    zlevel: this.getZlevelBase(),
                    z: this.getZBase(),
                    style: {
                        x: a,
            ...
            var e, t = this.reformCssArray(this.rcOption.padding), n = this.rcOption.width, i = this.rcOption.height,
            ...
            return {x: e, y: r, r: n / 2, width: n, height: i}
    ...
    function t(e) {
        ...
        for (var t = e.features, i = 0; t.length > i; i++) for (var a = t[i], o = a.geometry.coordinates, r = a.geometry.encodeOffsets, s = 0; o.length > s; s++) {
            var l = o[s];
            if ("Polygon" === a.geometry.type) o[s] = n(l, r[s]); else if ("MultiPolygon" === a.geometry.type) for (var h = 0; l.length > h; h++) {
                var m = l[h];
                l[h] = n(m, r[s][h])
            }
        }
    ...
    function n(e) {
        ...
        var i = t(n.getAttribute("x")), a = t(n.getAttribute("y")), o = t(n.getAttribute("width")),
            r = t(n.getAttribute("height"));
        return {left: i, top: a, width: o, height: r}
    }
    ...
    function i(e, t) {
        function n(e) {
            ...
            if (m[t]) {
                var o = m[t](e, i);
                o && (o.scale = i, o.properties = {name: e.getAttribute("name") || ""}, o.id = e.id, s(o, e), a.push(o))
            }
    ...
    function s(e, t) {
        var n = t.getAttribute("fill"), i = t.getAttribute("stroke"), a = t.getAttribute("stroke-width"),
    ...
    var h = e("zrender/shape/Path"), m = {
        path: function (e, t) {
            ...
            var i = t(e.getAttribute("x")), a = t(e.getAttribute("y")), o = t(e.getAttribute("width")),
            ...
            var i = t(e.getAttribute("x1")), a = t(e.getAttribute("y1")), o = t(e.getAttribute("x2")),
            ...
            var n = parseFloat(e.getAttribute("cx") || 0), i = parseFloat(e.getAttribute("cy") || 0),
    ...
    function t(e, t) {
        ...
        for (var n, i, a = e.features, o = 0, s = a.length; s > o; o++) if (i = a[o], !i.properties.name || !t[i.properties.name]) switch (i.type) {
            case"Feature":
    ...
    function n(e, n, i) {
        ...
        for (var r, s, l, h = e.features, m = [], V = 0, U = h.length; U > V; V++) if (l = h[V], !l.properties.name || !i[l.properties.name]) if ("Feature" == l.type) a(l.geometry, l); else if ("GeometryCollection" == l.type) {
            r = l.geometries;
    ...
    function a(e, t) {
        return o.offset = e.offset, o.scale = e.scale, t instanceof Array ? o.makePoint([1 * t[0], 1 * t[1]]) : o.makePoint([1 * t.x, 1 * t.y])
    }
    ...
    var o = {
        ...
        formatPoint: o.formatPoint, makePoint: function (e) {
            ...
            t.xmin > i && (t.xmin = i), i > t.xmax && (t.xmax = i), t.ymin > a && (t.ymin = a), a > t.ymax && (t.ymax = a)
        }, Point: function (e) {
            this.makePoint(e)
        }, LineString: function (e) {
    ...
    return {
        ...
        features: [{
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@lnnK@娄n@@V聜V聞@@VV@nIV聞V@VW虏a@b@bVnUVVV@V聶z@l職@掳U職V聞IVaVV@x@聨XX@WlwUnV@XblW聞b@XlK@a職@k聝@al@@_V@@W脜wmaUaV@聞bnaVL@llInmU_@W@a聝UU膲UaVwm@X聧WK@w聝VkaVUUwU@@aV@@mlI@W聹LW聝UUU聝VU@kV@XalKVaU聝VUUUk@WwUK@aVI@W聝Uk@@UUU卤xkb@lV職@xnL脟bUbk@@b脟VUJ卤U@U聴@WLX職ml@bVVXL@lV@@LmbkLW`kbVxUn@LkxmV@bm@@VkV"], ["@@VVVkV@聛楼@UV@U@VUUJ聝kWakKU職lXVJ@bXV@blX@aXV@V"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@聞脪V陇@录V虏@aVV@聨@聞聞x掳V職拢nW聜@nbnaVXVW@k@aV@VU聹Ul聶掳JUkVm@U@UkK炉聧WVkKWkU@Ub聝akwml聛wm@聝kUm聝UUKU@@VmLUbVLUV炉U"], ["@@聛LllUL@Vlx職L@a@U聝wXamK"]],
    ...
    return {
        ...
        features: [{
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@譬虙虖艑押虙譬聵贸葎僻艑匹酮貌么帽葌處艕贸葌虙虗處聸么袧蓽聴谞處么艐蔀葊讯@么酮蠁聹屁艑蓺聹蓽葍贸僻屁匹篇聵@食譬聸蔀蟻輬@蠀袧蠁实蓽聵痞蟻屁僻虓蓾贸蓻压虓蟻艔虘么贸屁@聹僻痞么屁蓻@匹屁@葌痞@@么蓹艕僻识屁艑蠀聹虓處蓻艐么艒蓾@贸僻虓聸痞实训食么实蓽艔蟼么篇艐屁艑蓺@么袧匹僻@艒迅蓻虗么處实训袧原@虓虓僻貌@葋蓾@蓹蟻蠀桐篇虖譬玫僻艓僻艒贸職啷∪勆浭渡溔€@蔀蟼讯僻聹匹蟼蓻艕@蓺蓽蓽@艓么么蟼聹篇蟼"], ["@@玫蓹@僻蓻聵@艕贸痞蠁么"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@蔀蟼屁聹蓻葊么艕跀蓻贸蠀么虓谉艔虘虙"], encodeOffsets: [[123840, 31771]]}
        }, {
            type: "Feature",
            id: "xiang_gang",
            properties: {name: "棣欐腐", cp: [114.2578, 22.3242], childNum: 1},
            geometry: {type: "Polygon", coordinates: ["@@贸蓻譬@蟻@贸聹么葊蓺艓屁@枚@@艒屁@"], encodeOffsets: [[117361, 22950]]}
        }, {
            type: "Feature",
            id: "ao_men",
            properties: {name: "婢抽棬", cp: [113.5547, 22.1484], childNum: 1},
            geometry: {type: "Polygon", coordinates: ["@@X聧炉aW膧聞@l聫"], encodeOffsets: [[116325, 22697]]}
        }],
        UTF8Encoding: !0
    }
    ...
    return {
        ...
        features: [{
            ...
            geometry: {type: "Polygon", coordinates: ["@@VL職@VV聞@VL@aUK聝IUU聝@@JUVU@"], encodeOffsets: [[109036, 30257]]}
        }],
        UTF8Encoding: !0
    }
    ...
    return {
        ...
        features: [{
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@la聞U職聫職@職UnL@VWbklWxnIVV聞V@X聞JlbUl職XVbn@@K聞mV@@X掳WVInJmn虏@lmVbnL@amKV_kwlmX@@LVamaXa聝aVU@UnJVanLlUkaW@UaVakK@IlKUU@an@ln@alKU聝kIVa@a@klaUKUV@UkUV炉職KV聝V@kUm聝U@@a炉ImJUU@VV@UL@U聝@@WXUWa@Ukwm聶@聝X@@w@al@@aVIUmVUUUVWUknK@I@聶l楼kU卤a聶聶UUVyUw聝@@I@UUWm@@Uk@@nUJU@WU炉@kbWlULn職脟聞k录@llL職l@xUn贸聨聝L聝lkXUx聝V@lWb聞I聞`掳nnn聶ll聨V虏炉x@Jkb聝LU聞VxmJX虏@脪WV脹L@lln@聜Xn聵職nV聞L"], ["@@@kX@Vala聛a@KWI@UXW@聧WanaUIW@UaUK姆聨k_W@UVUKU職@b聝@UamxVXnJUbWVXLVbn@W掳kb@U@W贸录mIU录k`V聞@bVbl@聞lX@lU么VlU聹IV`lX聞Vn@lUlVn@聞l@UVa聝IUWl拢Um聶聛VWU@@UUKlUUUn聝VL@K職UnLVWUa聸@聶U"]],
    ...
    return {
        ...
        features: [{
            ...
            type: "Feature",
            id: "4206",
            properties: {name: "瑗勬▕甯�", cp: [111.9397, 31.9263], childNum: 7},
            geometry: {
                type: "Polygon",
            ...
            type: "Feature",
            id: "4210",
            properties: {name: "鑽嗗窞甯�", cp: [113.291, 30.0092], childNum: 7},
            geometry: {
                type: "Polygon",
    ...
    return {
        ...
        features: [{
            ...
            geometry: {type: "Polygon", coordinates: ["@@D聠T@FCHG\\FFOROMEgYc@"], encodeOffsets: [[119992, 40041]]}
        }],
        UTF8Encoding: !0
    }
    ...
    return {
        ...
        features: [{
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@雀氐蕦詪葮藭蛺询謯忙摔艩椰艧挪蓘蓚莹远聬庐皮褨H帽獭唰碦f諌菫蜁奴詰脰垣霜谭颅唰內济嘉簊源糯夕鹿臉使末小屁峡暖炭卯虂醿聺幡抵ほ嬚涸洁怀蝸釒澟犠嬓栤偔聴诺脧詢蠟寨~詨茲袡菂每請艤輮虃迴陋伟藲荻权螁訕占藧蠍臉噩芦訆剩虦伞詺鹊詭庐迁识同虱呒牵謿褋諓膭菐螌艛蕭g處母釤淸"], ["@@蓧臈桑賱图未湿茦蛝私泰钳茘蓫位"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@邨搂褤虜詰x啵慇A釄炌捪笛€乜嗒ㄔ嬥瓤蠙锌"], ["@@哟貒蜖诎啷犅撈娗粪欢嗟嬠娕粪▎丕唷就∨ο囙牎啾о森啶寂汾斊堔傎⑵庉愋肚堁動漣冢刍药譄蝸啷呧爟喃冉讠桑唷筎酄非饺嚸澱嬔┄軝艞變諃谓搂效忒嗒佮皼覊醽嬊┼膸前詤牵鼗坪褖詪虖唷迸欉碧暽椗溹牫吱失覡藛盛学逈驶诃怨奴唷嬋Ｒ囘廍趦褭蕥乜酄炟欉η澦枯Τ觾毡唳熮嵧呄克斷謹印螣篓蕞苺釒撆捨懹猦鼐謸脙虖台贸啖嘿は喫堈捘屟拒斕珮臎硬尉莿臋蛣系菤刷螠蠜蛨葷啷和盖⑵權█葼唷采ぽ⒃娞ㄊ爯E逇賻崭o郯訏酄嶥逌蓳贫檄喔愒『每酄€虦迍占邆爪院圣廷乾藬喽斷６写虁啖幠股傐亨缺"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@炸藘邜目聢菂山希嗖嚸僸覀女螏脢洽"], encodeOffsets: [[70590, -49792]]}
        }, {
            type: "Feature",
            id: "AUS",
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@吆虂覝艠倬菉詭脡脨唳剿教伳撢壣白嵶懬€原軜艞謭訚芨t犀占玫"], ["@@挞趪闸蛣甩巍袞蜔膽蠇谴軟鸥薪蓜墓涩軙膮靴藮汁啵π嬛炍慌嬋斦兺溹＇筒葌途畏却藕脾啖棺┫竿嬟€诠蕗诃t訌脣猿袗軏碌輷啤系嫂荨j訒菚谆蠂迖孬协太俦双谐蕽堙蜁薪蓞鼗艍讈陋藝訒虈啶德夀∥囅櫾曃熛堅テ佳澢冚佖壾┥壠動懨斶渴愓毁捜浹屝具蹦杆⑿犎残ё壿澠费队炌樞Ｘ佨懺克酵徻涃轿妦襽钥貙压蛝莻葮嗒冊氉焭忒笑嗪撃佮獩虧啷櫵∶堗⒒褭墀葪菈驯坛涂軌q諈玫輵贫卓臒纸聺詠覂蕰聹褍蕘袟藡貢聬譀B啖秸溡嬊刲訓泻艠茪葤聡虪暮讗模蛹鸦唷柶徲捖樣幫秙蕷蠇桶慕趧訐跀艡为蟿蔚顺蕃懈蕬蕿蜅a褬械趲膬藙葲师臓訝洽雀艠褉臋赢螏貈脷贂微讇踿爽笑为贉贪悉脿纱幕趲毯詺膜哦葊蔀眉椰o啖ㄊ栆毾幧娨営惭惵溚瞯覙讟軒螤堠桅菤虠袌藗孝蠄腔母贃覡邪犬通褑茰`杉蟿沫d蓚蟿纽袨艛亘汐也咏諅M諙每潜姚袛讵蠝蓸趴染魏訏詷虙褬谋酆莻e褨貨刷覀弄謳然襽螄奂蓩蕡膼远实蝇蕣蛡帽葼菉犀械伞覈蛪突丝聝漠捅蕶锌虠协脭蕘跍耀侉藦褷虂貓踊蕚B寻蓫哦史撙说謭思菒見菭蠈木窑拾跒艥袨脭蕯墨訑艑賳菆菭沤爽犬丫菃姚t蕡谈叹蕚些脦諆染姆聵螞台褢脷訃聡胎"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@蕿桑蠄DG呕蝿印纸艗褖习苾蛦仟v"], ["@@蠆脣茷蓤詧秃汛训褣篆虾聼矢骚蹢茫疲俚茻虓汰葷v蟹冉楼曰巡虃写蕽蕷炭脳唳讓蠗茞违涩蕚藢覂司菧蓚蛬皮千蓺榷茙囟蕧覑鹿艠牟斜覕蓴艢蕗聟讇詸"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@脕唰ι兿⒃溍熓灿幰€脜赂艇歉葟T藯裙黔蜎勋抬胎螎聼"], encodeOffsets: [[30045, -4607]]}
        }, {
            type: "Feature",
            id: "BEL",
            properties: {name: "Belgium"},
            geometry: {type: "Polygon", coordinates: ["@@販谩蕺仟諓慰姚葷魔支蓵聧臐一芸夕褯脽讚袉戏投戏`农虙讵菙"], encodeOffsets: [[3395, 52579]]}
        }, {
            type: "Feature",
            id: "BEN",
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@鹊拢蓢訙炭蕫蔷諗狮聭處郏J鹰"], ["@@啵菲吤徧葱偯ぶ坽~蓵"], ["@@茻庄品艈`旬蠐酮C莫趷蠗"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@同叹軒尧聸携路諞袘聙黔斯膝薛"], encodeOffsets: [[116945, 4635]]}
        }, {
            type: "Feature",
            id: "BTN",
            properties: {name: "Bhutan"},
            geometry: {type: "Polygon", coordinates: ["@@蝹藣脧冤蹏{劭脠諊趴迏蛫k菤謱夭覓蓤赘葯押q蟺丧"], encodeOffsets: [[93898, 28439]]}
        }, {
            type: "Feature",
            id: "BWA",
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@B釄澿@話w帅突軟驶协聜踊盲貜狮啖熍ㄠ腋唷庎瓋啶钝樓謼喃溙熝⑾樦恨犖幾澳�"], ["@@廷喹呚喤樐荷佀苦啵敌陈€喽撉撌ν∽ピ拐贿佁涋兡€呖垣唷瓜笍蓴频C逈討酄峱郫賺辗F迿十酄徳壧］∪熰”茪唰客非∪炧ス蠝蛧恕螞隙菣臍蛢谓莾臏颖太喃椦杰撃嬎囌戀Ｏ吤脆⒐虗抬謹脛g亟螔萤釒斉戅枯漃袡确莘蹋茐薰危o啷吽氞ェ讙@@啜秤斔佌捠動把呏捙呧筏桅甙啖促班保蕯邽輶烁喽娻い虖旬醿捴澤犑苦ɑ諌艩藗喈菜亨紥袭指蕧酄幟┼螤聞渊啻堗磶韦喟椸凹胜蹥牡啜炗▎瓢嗑核掅儨藔釄っ曕禈签喈勓溕屔ρ毿迸愗呇次∷呥揭屶す"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@詪诠啖熡勁澪掄栓藥褍"], ["@@鹊蛢省臑貋貋僧啸諢欧賸艓徒也}唷斏屖屆€虗纱诋蕚聝褲薀藱亩山覙诺"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@虃蕧茡循猿艞药募膮蟿蜄虁悉幕燃茞"], ["@@諞钳艆碳芯扦藠掳影藔@效諘确"], ["@@茅颅@楔迁聻慕袟"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@唰樤屲幦吭屚蹿ο櫴ヌ嬥瑡圣蠙虒軏蠙锌蠚"], encodeOffsets: [[-62668, -53094]]}
        }, {
            type: "Feature",
            id: "FRA",
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@耍侪稀菭葯症菧毯炸蛶茰軟"], ["@@讛袇褱脿輤膝葕帽蕩j袌蓷喁喥费嬛古冏成逼澫Ｃ悸偵囏櫼絔蠠袙苺司蟻聯蕘蕷炭虆石蓯俦覗艃末畏菘訁醼吷藯末詰唳吪夃た蠟抬枪嗷瓜⑼溠⒃幥嗎€班啖へパ庎惫蛼膷貣嗒犌距懂蓮藝啷庍屛嫚倬狮蹘芫菫弄虘细_细偷"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@覊纸賸铅员[铅見钎覉鄞聳啵斣�"], ["@@啵嬥＇唷ε樴I蓵蹍莜荸啖劽兠つ曒犩Ρ趾茋袁啷澥埻оО菂姆諠褤蕳筒眩荼询喃砇喾澤毕磺捴壪哭ツ澩嵰伹樴啖ㄝ篛B嗖狡斒兺班屎摇覑菃占喟⒚稤@女婴譀援_\\唰灯ㄈㄏ捤∩匆嵭嚶愤堆壯斕ㄠ俣诰冥谩唰γ�"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@

            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@虩趮挪使黔褲贊蛣褢臑喹┭惻炑溹没唷犢捗�"], ["@@詫篆艧喃曄Ｃ偽佀嚿灺戉Ж葥訏舀楼褉始"], ["@@喈吧從澬и澟佁椔残纺皇囁犙戇€褔褑蹧啶壁哃炔葍山菞莳胎貭施軠勋臄瓶平虥爷霞艹茞螡斋貓谭谋勋螚鹿覅軟螘脻H什洽見羌嵌蜐婴时褕螒艀蕸未眨拼蔚投孬脝倏蠝迲沾织訙士酄鼓佀は曈澫滴撁暷敢暸勆徺蔡喪笆櫷€聰蕚尾堑袦垄壹硕脾苾袗聙羌秃鬲目蠄茪芒螁詷拧漠菃酄ㄆと娞�"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@症梅襽全茢莎谉e虱茥夜茒討酞亩葦螠脦葤聝"], encodeOffsets: [[-79431, 18935]]}
        }, {
            type: "Feature",
            id: "JOR",
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@艈私铱詴螇藧褭葲蓾迎辗蕡R袏椰詥訉墨螉螠貭枪"], ["@@蛠凇皮褋雪祝喋剐冟箯陆喈｀ァ帧蛿聯睾喔┤冟Ψ袃唳漞唷炟Ｖ椸窏斋螡袧蜏榷荻諒蕭涂志邜识巡請唷屟⒇炛羔€む牵啖犩购謹袘喁距訉蜏請啜埰熰ぞ微諑啵€聘覟喹梷诨蕙唷峛啖�"], ["@@谞堑专韦葓啶灌皾莎輥酄编硴指覜啶佮ぃ]艡酄葱促ㄠ虏蕱喹愂溬监Θ啖撡に�"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@乾蠂玫葥藬賴砖u冉袗轃膯貫弋譅茅"], encodeOffsets: [[49126, 30696]]}
        }, {
            type: "Feature",
            id: "LAO",
            ...
            geometry: {type: "Polygon", coordinates: ["@@桑[媒匹双D虡蹌屑注f聢蠘搂茞停覜蛢确覠"], encodeOffsets: [[36681, 34077]]}
        }, {
            type: "Feature",
            id: "LBR",
            ...
            geometry: {type: "Polygon", coordinates: ["@@懦啖撐櫴囓等撔嵹溒瘈蠣啻甲喴毕鹤⌒炧"], encodeOffsets: [[83751, 7704]]}
        }, {
            type: "Feature",
            id: "LSO",
            properties: {name: "Lesotho"},
            geometry: {type: "Polygon", coordinates: ["@@虇施食校茮藳页趴乒藣虥膵乜侉覄諓覗廷霞菭尉实"], encodeOffsets: [[29674, -29650]]}
        }, {
            type: "Feature",
            id: "LTU",
            ...
            geometry: {type: "Polygon", coordinates: ["@@菢葟鲁蟻蕧i葔貌臑壹蓶聨"], encodeOffsets: [[6189, 51332]]}
        }, {
            type: "Feature",
            id: "LVA",
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@脿褯謭亩藶螆葮媒痈該螠譀露郑臋稀膯丝脰踊虙傻亭輵e顺撰脡邞禺唳第毮捰熤毰涆犔∫溎犡斎兾てて埾�"], ["@@兀斯墀茪啷盄虆啷椡撎囇權瓱蹍堑邞删袝贸萤褖諞脪乍菬址訂茣謽販私佼莯菧軉维莻唰柷鹤沮斝愊ρデ盒�赂諟聹邪侏讗褕趢图H褱褘聻喂謫苫郜失脩汀譂楼飘效"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@
]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@山膷蔚蛿蟻諗欠贅艤膯臏省尸葟袪諔袌说艥山"], ["@@询莽苾山覠缺褯葻呀B蹚蕯討珊锚屎莠农覡脿哦袞纽r膯呀訍脺蕚思腋虤摹痈詫f菧茝g爷睡浴"], ["@@荬湛詹啖挥柭劼懴壻浭デ佮螡摹蕪謰脧确蓴軣摩唷暸促氛氂壱ρл€嗒€車蕠浴耍艅廿趪丝一茤啖吢朼岍抋岍掄笭變嗉娪撟勓椧囱吪赣掂稊员炔呀逈臎葎謺"], ["@@士伞莵痈葷蜆蠞藶訊为貒蕷珊犬覓苫烁葋螠全痛螞蛫藦亩学"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@褬玫瓢菚蓩蓛賲L荧聡路维泞努蹖K"], encodeOffsets: [[-67873, 18960]]}
        }, {
            type: "Feature",
            id: "PRK",
            ...
            geometry: {type: "Polygon", coordinates: ["@@脟財扫巡砂臏尸藖d盈墙映傻脩诗菛"], encodeOffsets: [[52030, 25349]]}
        }, {
            type: "Feature",
            id: "ROU",
            ...
            geometry: {type: "Polygon", coordinates: ["@@同觾碌拥蕪艁芽脝时訊詻脿镁覡艠脼聦詣蕩珊劝膹詧矢"], encodeOffsets: [[31150, -1161]]}
        }, {
            type: "Feature",
            id: "ESH",
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@删丝讞N蛪袁詧券菧聣"], ["@@蜐m鸳膸谦偶脌彤謭苼藴黔茙蓹"], ["@@懦乒丨馨谦詧撕@虪讠痛袟"], ["@@聳菦趨桅覠虪炭霜虐膼袭全蹛檄娶藟"], ["@@菞鲁慰葤螄螉篓茤詧巍桶藳"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@恰蠉迎臎詤覗S虅砂蛝膫蕯蕫脪褕频虐蠒冒蠅"], encodeOffsets: [[32842, -27375]]}
        }, {
            type: "Feature",
            id: "SYR",
            ...
            geometry: {type: "Polygon", coordinates: ["@@牟趣堍葘讝聠藔艀蛦慕摊色啖曃扣呈媏尸膹菙"], encodeOffsets: [[127968, -9106]]}
        }, {
            type: "Feature",
            id: "TTO",
            properties: {name: "Trinidad and Tobago"},
            geometry: {type: "Polygon", coordinates: ["@@託艎钱聡聭氐郗摹漂煤蕭刹i酮"], encodeOffsets: [[-63160, 11019]]}
        }, {
            type: "Feature",
            id: "TUN",
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@喈和椸偶埭玫唳惭垄叽协茰虘膬校夭然通蕰只蕠藔啷徥灰犣暺櫶徤娻艌委沤啷椗揭廱啷程扣旹襾莯啶嵣顾澢惵飞Ｇ可Ｇ刻毕犕埻傇熋比栔坑權保磨诠見啵熉喨椢懽嚹尺灰勦；e咏酄敦椧靶刚撔掄擗嗖捖捨溬斷線艔唰炚班蕜嗟糽喔缸�"], ["@@郢覐藘虾\\铅圈摩屎諅啸蔀唷λ勡づ懩赐撥妓撈等掂卤惟史"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@
]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@耍艒谁蟼聦嗓諉訔"], ["@@茖诒丧艀签颅钮纱i佗袛实"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@@裕怒蕶袃艜聵蓽蓪艢蓙摩乾謹踏艣"], encodeOffsets: [[36399, 33172]]}
        }, {
            type: "Feature",
            id: "YEM",
    ...
    return {
        ...
        features: [{
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@釄楲@脠掳膴葌蓡茠脝膴拢聞钮么聛W脫蓡b蘑脜艓聝脝娄膶脩W楼掳姆U炉茝艃V膿卤脻@贸聴莽聵沫聛蓛凭艡脝姆kw殴聝扭鹿摹楼牡K艔脜Xm藣聬褖w菗陇茟聧@w贸聫艒V姆拢杀職摹么脹a卤脪葋聞贸猫牛IV聨平录k陇贸鹿摹Jmx聴禄脻U聝虏聶@脜脝聝母谦艓聞膴m艓乾諛"], ["@@脼么掳b脼菭么脺么n@掳母艅聵嵌k艂聝录U脼聶K臒膶聜脝脻蘑脜陇姆@@螌诂L軇K@耍葌谁l膲脜聞W楼牡V脝媒@艃脼膿U艃葪茀@殴譬菚膲禄k禄脟聶V臒贸艡X聧聶聧呕K茝聨膵锚葋猫脹艓摹聝桐艅"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@膲聞脝艠葋虗m脼炉膧X掳卤录@凭炉拼掳艓脻镁艐娄W脺脼b葌膲藕U聹脟mwVU葌贸么@劝脻蝷聧n聧脝Jn聶凭聶薁聶艑L膶贸仟炉聹楼菙a菛職艑a么脻蘑L職x聞聝脝L職聧刹m聞聶虏Vlw脠@聵聧U聝茠聧掳炉菛x膴mU脩屁a掳脜掳WV鹿聹a聸脟蓛脠m楼掳炉殴贸母姆谦Um禄脜录脟V杀聧聶l脻聝艐n姆脟脻X炉聝桐脟沙a聴聴脻`卤_U卤牡nW聝聶a@聶母贸職姆聶炉菗V卤脜牡J膵鹿蓞ykw脟聞炉拢脜x薀禄聝l姆I炉聝X炉姆聜聶锚菚聝拳n姆禄殴`卤聞k脼@聨職聞脻么@脼掳x職扭艓I屁脝Ux艒職炉虏菙默乾lU艢"], ["@@脼膧l藕聝娄炉母扭K脼聶職聧聝膵屁b職聶V臒聴w聸摹炉@牛聬平J"]],
            ...
            geometry: {
                type: "MultiPolygon",
                coordinates: [["@@蓽脼蕣聫膴媒Va脜聝m禄实瞥茟蕽葪墨V楼炉膲掳脩@艃脜I聶禄膲聫m臒n聶聝a脻職牛L掳姆贸K牡膧V蛨膲艂凭菉脝扭聝zXl掳聝脝L虏录藕聨么脠蘑菙聶娄l聞么掳"], ["@@凭I扭聫@UUw艒a聶膲脻J臒脩脝艓k艓"]],
            ...
            geometry: {type: "Polygon", coordinates: ["@@l艁聴堑m聜膲@m偶聶录n掳脼m脝录職@"], encodeOffsets: [[88178, 45529]]}
        }],
        UTF8Encoding: !0
    }
